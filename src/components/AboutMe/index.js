  ...
  return (
    <AboutMeStyles id="about-me" className="about-me">
      <div className="about-me--texts">
        <HeaderSection
          title="ABOUT ME"
          className="animations-move-bottom-d-1"
        />
        ...
        <h4 className="about-me--texts--title animations-move-bottom-d-2">
          Hi, I’m José Victor. Nice to meet you!
        </h4>
        <p className="about-me--texts--paragraph animations-move-bottom-d-3">
        ...
        <p className="about-me--texts--paragraph animations-move-bottom-d-4">
        ...
        <p className="about-me--texts--paragraph animations-move-bottom-d-5">
